...
def load_embedding(file_path):
	...
	file.close()
	num_features = int(file_contents[0].split()[1])
...
def calculate_features(new_edges, embedding):
	...
	for u in new_edges:
		for v in new_edges[u]:
			...
			# features.append((average_feature(x,y), hammord_feature(x,y), l1_distance_feature(x,y), l2_distance_feature(x,y)))
...
def main():
	...
	new_edges = ['data/sample/hijackers_newedges.npy', 'data/sample/dblp_newedges.npy', 'data/sample/higgs_newedges.npy']
